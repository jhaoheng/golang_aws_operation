...
// // 計算多少錢取得多少資料
// func GetItems() (allItems []DDBAgent.ITEM, totalRCU float64) {
// 	/*
...
// */
// func GetByCreatedTsWithUpperBounder(ts int64, totalItemsCount int64, exclusiveStartKey map[string]*dynamodb.AttributeValue) (saveItems []DDBAgent.ITEM, lastEvaluatedKey map[string]*dynamodb.AttributeValue, rcu float64) {
...
// 	//
// 	output, err := DDBAgent.DDBAgent.ScanByCreatedTs(DDBAgent.Lower_than, ts, limitSize, exclusiveStartKey)
// 	if err != nil {
// 		panic(err)
// 	}
// 	//
